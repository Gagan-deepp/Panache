        ...
        <ScrollArea className="h-[60vh]" >
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4" >
                    <div className="flex gap-2 items-center" > <CalendarIcon className="w-5 h-5 text-muted-foreground" /> <span> {date} </span>  </div>
                    <div className="flex gap-2 items-center" > <MapPinIcon className="w-5 h-5 text-muted-foreground" /> <span> {venue} </span>  </div>
                    <div className="flex gap-2 items-center col-span-2 " > <UserIcon className="w-5 h-5 text-muted-foreground" /> <span> {faculty} </span>  </div>
                </div>
